...
```{r}
college_recent_grads %>%
  arrange(proportion_of_women) %>%
  select(major, total_number, proportion_of_women)
```
...
ggplot(data = college_recent_grads, mapping(x = median, y = proportion_of_women)) +
  box(x = "median",
...
What is the relationship between the major type and the proportion of women.
...
ggplot(data = college_recent_grads, mapping(x = stem, y = proportion_of_women)) +
  box(x = "stem",
      y = "proportion_of_women") +
  geom_histogram()
